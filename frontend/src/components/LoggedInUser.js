...
function App() {
  ...
  return (
    <>
      <NoteState>
        <Router>
          {user !== null && <Navbar showAlert={showAlert} user={user} />}
          <Alert alert={alert} />
          <div className='container'>
            <Routes>
              ...
              <Route path="/:username" element={<OtherProfileWrapper loggedInUser={user} />} />
...
const OtherProfileWrapper = ({ loggedInUser }) => {
  ...
  return <OthersProfile loggedInUser={loggedInUser} />;
};
